...
export async function resetDatabase(prisma: PrismaService) {
  ...
  await prisma.departmentQueue.createMany({
    data: [
      { id: 'queue-1', name: 'Technical Support', description: 'Hardware and software troubleshooting' },
      { id: 'queue-2', name: 'Billing & Invoicing', description: 'Payment issues and subscription inquiries' },
    ],
  });
